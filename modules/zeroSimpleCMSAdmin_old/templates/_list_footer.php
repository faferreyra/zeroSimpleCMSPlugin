...
<?php if ($sf_request->getAttribute('page_names')): ?>
  ...
  <?php echo form_tag('zeroSimpleCMSAdmin/addPage', 'name=cms_tools_create_page id=cms_tools_create_page style=margin-right:270px') ?>
...
<?php else: ?>
  ...
  <?php echo form_tag('zeroSimpleCMSAdmin/createRootPage', 'name=cms_tools_create_page id=cms_tools_create_root_page style=margin-right:270px') ?>
