...
<?php if($publisher_credential && !$sf_context->getUser()->hasCredential($publisher_credential)): ?>
  ...
  <?php endif; ?>  
<?php else: ?>
  <?php echo link_to(image_tag($is_published ? '/sf/sf_admin/images/save.png' : '/sf/sf_admin/images/cancel.png'), 'zeroSimpleCMSAdmin/togglePublish?id='.$sf_simple_cms_page->getId()) ?>
<?php endif; ?>
