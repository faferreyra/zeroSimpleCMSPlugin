...
/**
 * This class defines the structure of the 'sf_simple_cms_page_archive' table.
 *
 *
 *
 ...
 */
class SfSimpleCmsPageArchiveTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'plugins.zeroSimpleCmsPlugin.lib.model.map.SfSimpleCmsPageArchiveTableMap';
    ...
    {
        // attributes
        $this->setName('sf_simple_cms_page_archive');
        $this->setPhpName('SfSimpleCmsPageArchive');
        $this->setClassname('SfSimpleCmsPageArchive');
...
} // SfSimpleCmsPageArchiveTableMap
