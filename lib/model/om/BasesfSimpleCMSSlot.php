  ...
  const PEER = 'sfSimpleCMSSlotPeer';
	...
	public function setDeletedAt($v)
	{
		...
		if ( $this->deleted_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = sfSimpleCMSSlotPeer::DELETED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = sfSimpleCMSSlotPeer::NUM_COLUMNS - sfSimpleCMSSlotPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if (!empty($ret) && sfSimpleCMSSlotQuery::isSoftDeleteEnabled()) {
				$this->setDeletedAt(time());
				$this->save($con);
				$con->commit();
				sfSimpleCMSSlotPeer::removeInstanceFromPool($this);
				return;
			}
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->asfSimpleCMSPage) {
				$result['sfSimpleCMSPage'] = $this->asfSimpleCMSPage->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfSimpleCMSSlotPeer::DELETED_AT)) $criteria->add(sfSimpleCMSSlotPeer::DELETED_AT, $this->deleted_at);
	...
	{
		sfSimpleCMSSlotPeer::disableSoftDelete();
		$this->delete($con);
	}
