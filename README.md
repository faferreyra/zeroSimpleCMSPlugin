zeroSimpleCMSPlugin-symfony14
=============================

CMS plugin for symfony 1.4 based on code from sfSimpelCMSPlugin made by francois for symfony 1.0.
...
Please note that this plugin is in active development. If you want to help and improve it, please contact FranÁois Zaninotto.
